                    ...
                    <div class="row">
                        <div class="col-md-6 col-12 col-lg-6 banner____ col-xl-6 mx-auto">
                            <div class="text___banner___header" style="padding: 0px 36px;">
                                <h1>Organizein Zambia's Trusted IT & Search engine marketing Agency
                                </h1>
                        ...
                        <div class="col-md-6 col-12 col-lg-6 banner____ col-xl-6 mx-auto">
                            <form action="http://localhost/multipageadmin/auth/inquiry_handler.php" method="post" class="contactForm">
                                ...
                                <input type="hidden" name="current_url" value="http://localhost/multipageadmin/zm/molestias-modi-sapie/est-eaque-praesentiu/search-engine-marketing.php">
