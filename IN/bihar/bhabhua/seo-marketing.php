                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 col-12 col-lg-6 banner____ col-xl-6 mx-auto">
                            <form action="http://localhost/multipageadmin/auth/inquiry_handler.php" method="post" class="contactForm">
                                ...
                                <input type="hidden" name="current_url" value="http://localhost/multipageadmin/partnerwebsiteresources/index.php?partner_id=81&service=Seo+Marketing">
            ...
            <div class="bannerContent">
                <div class="headingContent">
                    ...
                    <input type="hidden" name="contact_form" value="form-2" />
                        ...
                        <input type="hidden" name="actual_url" value="http://localhost/multipageadmin/partnerwebsiteresources/index.php?partner_id=81&service=Seo+Marketing">
