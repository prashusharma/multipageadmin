<?php
    ...
    if(isset($_POST['edit_message'])){
        if($_POST['edit_message']=='edit'){
            ...
            $sql = "UPDATE `inquiry_form` SET  `full_name` = '$name' , `company` = '$company', `email` = '$email', `phone` = '$phone', `website_link` = '$website_link', `from_website` = '$from_website', `budget` = '$budget', `message` = '$message', `date` = '$date', `form_number` = '$form_number', `ip` = '$ip', `message_url` = '$message_url' WHERE  `id` = '$id'";
